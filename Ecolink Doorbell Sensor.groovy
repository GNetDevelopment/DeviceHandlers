...
metadata {
	...
	definition (name: "Ecolink Doorbell Sensor", namespace: "GNetDevelopment", author: "Community") {
	...
	tiles(scale: 2) {
		multiAttributeTile(name:"contact", type: "lighting", width: 6, height: 4, canChangeIcon: true){
			tileAttribute ("device.contact", key: "PRIMARY_CONTROL") {
				...
				attributeState "open", label: "Silent", icon: "st.Home.home30", backgroundColor: "#53a7c0"
			}
